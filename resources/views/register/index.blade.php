                                    ...
                                    <div class="card-body">
                                        <form action="/register" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control @error('name') is-invalid @enderror" id="name" name="name" type="text" placeholder="Full name" required value="{{ old('name') }}">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control @error('username') is-invalid @enderror" id="username" name="username" type="text" placeholder="Username" required value="{{ old('username') }}">
