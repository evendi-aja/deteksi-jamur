    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Tabel Hasil Perhitungan Awal</h1>
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-table me-1"></i>
                        Data Hasil Perhitungan Awal
                        <br><br>
                        <a href="/latih/perhitunganawal" class="btn btn-primary left">Perhitungan</a>
                        <a href="/latih/perhitunganpruning" class="btn btn-success" style="float: right">Prunning</a>
                    </div>
                    <div class="card-body">
